  ...
  if (loading) {
    return (
      <div className={styles.center}>
        <Spinner size={SpinnerSize.medium} label="Loading user and site information..." />
      </div>
    );
  }
        ...
        <div className={styles.siteInfo}>
          <Stack tokens={{ childrenGap: 15 }}>
            ...
            <Stack tokens={{ childrenGap: 5 }}>
              ...
              <Text>
                <strong>Description:</strong> {siteInfo.Description || 'No description available'}
              </Text>
              <Text>
                <strong>URL:</strong> {siteInfo.Url}
              </Text>
              <Text>
                <strong>Created:</strong> {new Date(siteInfo.Created).toLocaleString()}
              </Text>
            </Stack>
          </Stack>
        </div>
